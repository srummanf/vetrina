      ...
      <div className="flex flex-col w-full h-full">
        <div className="p-4">
          ...
          <p className="my-6 font-CabinetGrotesk_Light text-base leading-relaxed text-gray-300">
            Welcome to my{" "}
            <span className="italic font-CabinetGrotesk_Thin bg-[#2e2e2e]">
              fount
            </span>
            . Finally — we enjoin through some warmth and love.
            <br />
            <br />
            <span className="font-CabinetGrotesk_Thin">
              This space is a reflection —
            </span>
            <br />
            A moment to pause.
            <br />
            To <span className="italic font-instrument_serif">imagine</span>, to{" "}
            <span className="italic font-instrument_serif">think</span>, to{" "}
            <span className="italic font-instrument_serif">read</span>, to{" "}
            <span className="italic font-instrument_serif">reflect</span>.
            <br />
            <br />
            And above all, to embrace what's learned: through{" "}
            <span className="font-CabinetGrotesk_ExtraLight">trial</span>,
            through <span className="font-CabinetGrotesk_Thin">rhythm</span>,
