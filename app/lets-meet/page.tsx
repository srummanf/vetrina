          ...
          <div className="p-4">
            ...
            >
              <p className="my-5 font-CabinetGrotesk_Light text-base leading-relaxed text-gray-300">
                ...
                — drawn to existential depths — yet hopelessly romantic, often
                found reciting Urdu poetry under my breath. You get the picture:
                an ambivert with layers, my friend. */}
                <br />
                ...
                yes — Diet Coke with a 1000-calorie plate. Hypocrisy tastes
                good.)
                <br />
                <br />
                Am I always free? <span className="italic">Ha! </span> Not
                quite. But if you're my friend, or maybe my{" "}
                <span className="italic">amore</span> — I will definitely find a
                way.
                <br />
